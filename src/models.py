...
from keras.layers import Embedding, Flatten, Conv1D, Conv2D, GRU, LSTM, SimpleRNN
...
class KerasModel:
    ...
    def plot(self, filename='convergence.png'):
        ...
        plotter.showConvergence(self._history, filename=filename)